                            ...
                            child: Padding(
                                ...
                                child: SingleChildScrollView(
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (text) => {
                                        widget.product.setDescription = text,
                                        widget.updateFunc(widget.product)
                                      },
                                    )))),
                      ],
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            DateTime? newDate = await showDatePicker(
                                ...
                                firstDate: DateTime(min(DateTime.now().year,
                            ...
                            if (newDate != null) {
                              setState(() =>
                                  {widget.product.setExpireDate = newDate});
                              widget.updateFunc(widget.product);
                            }
                          },
                          child: Text(
                    ...
                    Row(children: [
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            DateTime? newDate = await showDatePicker(
                                context: context,
                                initialDate: widget.product.getPurchaseDate,
                                firstDate: DateTime(min(DateTime.now().year,
                                    widget.product.getPurchaseDate.year)),
                                lastDate: DateTime(DateTime.now().year + 5,
                                    DateTime.now().month, DateTime.now().day));

                            if (newDate != null) {
                              setState(() =>
                                  {widget.product.setPurchaseDate = newDate});
                              widget.updateFunc(widget.product);
                            }
                          },
                          child: Text(
